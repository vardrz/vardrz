...
[![Website](https://img.shields.io/static/v1?label=vard.is-a.dev&message=%20&color=green&logo=google-chrome&style=flat-square&logoColor=white)](https://vard.is-a.dev)
[![Email](https://img.shields.io/static/v1?label=fatkhurrozakf@gmail.com&message=%20&color=red&logo=gmail&style=flat-square&logoColor=white)](mailto:fatkhurrozakf@gmail.com)
...
🚀 **Fullstack Developer** who loves exploring modern technologies and building real-world solutions.  
💻 Focused on **Web Development**, **Mobile Apps**, and **IoT Integration**.  
🧠 Experienced across the full stack — from clean UI/UX to backend architecture and APIs.
...
### 🌱 Currently Learning
- Advanced Golang (microservices, WebSocket, background jobs)
